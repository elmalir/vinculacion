...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?php echo base_url() ?>/plantilla/css/assets/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<?php echo base_url() ?>/plantilla/css/assets/css/ace-part2.min.css" />
		<![endif]-->
	...
	<body class="login-layout">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Aplicación</span>
									<span class="red">Asistencias</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; dcc click</h4>
							</div>
										...
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
                                                ...
                                                <?php 
												 if (isset($errores)) {
													 if (!empty($errores)) {
														 echo '<small><label class="orange">'.$errores['mensaje'].'</label></small>';
													 }
                                                }
                                                 ?>
											</h4>
											...
											<form class="form-horizontal" method="post" action="<?= site_url('/log/login') ?>" >
												<fieldset>
		...
		<!--[if IE]>
<script src="<?php echo base_url() ?>/plantilla/css/assets/js/jquery-1.11.3.min.js"></script>
<![endif]-->
