                            ...
                            <div class="card col-md-6">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control is-valid" name="txtIdentificacion" value="<?php echo set_value('txtIdentificacion'); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Nombre Comercial</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="txtNombreComercial" value="<?php echo set_value('txtNombreComercial'); ?>" style="border-color: #000000;" >
                                        </div>
                                    </div>
                                    <div class="row">
