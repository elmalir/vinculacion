                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-sm-6">
                                                    <select class="select2 form-control custom-select" name="selectSexo">
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="row">            
                                                ...
                                                <div class="col-lg-8 col-sm-7">
                                                    <select class="select2 form-control custom-select" name="selectEtnia">
                                                        <option value="">Elegir</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <select class="select2 form-control custom-select" name="selectEstadoCivil">
                            ...
                            <div class="card col-lg-6 col-sm-12">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="txtOcupacion">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-5 text-right control-label col-form-label">Grupo Sanguineo</label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="txtGrupoSanguineo">
                                        </div>
                                    </div>
                                    <div class="row">
