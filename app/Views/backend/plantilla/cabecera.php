...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>/public/css/backend/assets/images/favicon.png">
         ...
         <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url(); ?>/public/css/backend/assets/images/users/d4.jpg" alt="user" class="rounded-circle" width="31" title="<?php echo session('correo'); ?>"></a>
                        <div class="dropdown-menu dropdown-menu-right user-dd animated">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo base_url(); ?>/login/logout"><i class="fa fa-power-off m-r-5 m-l-5"></i>Salir</a>
                            <div class="dropdown-divider"></div>
               ...
               <nav class="sidebar-nav">
                  <ul id="sidebarnav" class="p-t-5">
                     <li class="sidebar-item <?php echo ($menu=='principal') ? 'selected' : '' ; ?>">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url() ?>/inicio" aria-expanded="false">
                     ...
                     <li class="sidebar-item">
                        ...
                        <ul aria-expanded="true" class="collapse first-level">
                           ...
                           <li class="sidebar-item">
                              <a href="<?php echo base_url() ?>/admin/lstPacientes" class="sidebar-link">
                     ...
                     <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                           <li class="sidebar-item">
                              <a href="<?php echo base_url() ?>/admin/nuevaCitaGeneral" class="sidebar-link">
                                 <i class="mdi mdi-note-outline"></i>
                           ...
                           <li class="sidebar-item">
                              <a href="<?php echo base_url() ?>/admin/nuevaCitaGeneral" class="sidebar-link">
                                 <i class="mdi mdi-note-plus"></i>
                                 <span class="hide-menu">Odontológica</span>
                              </a>
                           </li>
                        </ul>
                     </li>
                     ...
                     <li class="sidebar-item <?php echo ($menu=='empresa') ? 'selected' : '' ; ?>">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-face"></i>
                           <span class="hide-menu">Empresa</span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level">
                           <li class="sidebar-item">
                              <a href="<?php echo base_url() ?>/admin/nuevaEmpresa" class="sidebar-link <?php echo ($subMenu=='nueva') ? 'active' : '' ; ?>"><i class="mdi mdi-emoticon"></i>
