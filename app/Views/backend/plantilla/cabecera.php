...
<head>
  ...
  <!-- sweetalert2 -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/public/css/backend/sweetalert2/dist/sweetalert2.min.css">
  <!-- Custom CSS  -->
            ...
            <ul class="navbar-nav float-right">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right user-dd animated">
                  <a class="dropdown-item" href="javascript:void(0)"><i class="ti-user m-r-5 m-l-5"></i><?php echo session('idEmpresa'); ?> My Profile</a>
          ...
          <ul id="sidebarnav" class="p-t-5">
            ...
            <li class="sidebar-item <?php echo ($menu=='empresa') ? 'selected' : '' ; ?>">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                ...
                <li class="sidebar-item">
                  <a href="<?php echo base_url() ?>/admin/listEmpresas" class="sidebar-link"><i class="mdi mdi-clipboard-text"></i>
