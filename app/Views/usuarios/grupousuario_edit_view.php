	...
	<div class="col-xs-12">
		...
		<div class="widget-box">
			<div class="widget-header">
				<h4 class="widget-title">Editar Grupo de Usuarios
					<small class="orange">
					<?php 
					if (!empty($errores)) {
								...
								<div class="row">
									<div class="col-xs-6 col-lg-6">
										<div class="col-xs-12 col-lg-12">Nombre
											...
											<input class="form-control" type="text" name="nombre" value="<?= $grupo->nombre ?>" maxlength="20">
										</div>
									</div>
									<div class="col-xs-6 col-lg-6">
								...
								<div class="row">
									<div class="col-xs-12 col-lg-12">
										<div class="col-xs-12 col-lg-12">Observacaión
											<input class="form-control" type="text" name="observacion" value="<?= $grupo->observacion ?>" maxlength="255">
										</div>
									</div>
								</div>
								<div class="space-4"></div>
											...
											<select class="form-control" name="selectProyecto" id="idSelectProyecto">
												...
												if (!empty($proyectos)) {
													foreach ($proyectos as $p) {
														if ($p->id == $grupo->proyecto_id) {
															echo '<option selected value="'.$p->id.'">'.$p->nombre.'</option>';
														}else{
