...
-- Schema sismedical
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `sismedical` ;

-- -----------------------------------------------------
-- Schema sismedical
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sismedical` DEFAULT CHARACTER SET utf8mb4 ;
SHOW WARNINGS;
USE `sismedical` ;
...
ALTER TABLE `usuarios`
  ADD KEY `Fk_IdEmpresaUser` (`IdEmpresa`), ADD KEY `Fk_idRolUser` (`IdRol`);
...
ALTER TABLE `citageneral` ADD KEY `Fk_IdProfesionalCita` (`IdProfesional`), ADD KEY `Fk_IdPacienteCita` (`IdPaciente`),  ADD KEY `Fk_IdEmpresa` (`IdEmpresa`);
ALTER TABLE `citageneral` ADD CONSTRAINT `Fk_IdProfesionalCita` FOREIGN KEY (`IdProfesional`) REFERENCES `profesionales` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
ALTER TABLE `citageneral` ADD CONSTRAINT `Fk_IdPacienteCita` FOREIGN KEY (`IdPaciente`) REFERENCES `pacientes` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
ALTER TABLE `citageneral` ADD CONSTRAINT `Fk_IdEmpresa` FOREIGN KEY (`IdEmpresa`) REFERENCES `empresa` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE `ciudades` ADD KEY `Fk_IdProvincia` (`IdProvincia`);
ALTER TABLE `ciudades` ADD CONSTRAINT `Fk_IdProvincia` FOREIGN KEY (`IdProvincia`) REFERENCES `provincias` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
ALTER TABLE `permisos` ADD KEY `Fk_IdRolPermiso` (`IdRol`);
ALTER TABLE `permisos` ADD CONSTRAINT `Fk_IdRolPermiso` FOREIGN KEY (`IdRol`) REFERENCES `roles` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
ALTER TABLE `roles` ADD KEY `Fk_IdEmpresaRol` (`IdEmpresa`);
ALTER TABLE `roles` ADD CONSTRAINT `Fk_IdEmpresaRol` FOREIGN KEY (`IdEmpresa`) REFERENCES `roles` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
ALTER TABLE `usuarios` ADD CONSTRAINT `Fk_IdEmpresaUser` FOREIGN KEY (`IdEmpresa`) REFERENCES `empresa` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
ALTER TABLE `usuarios` ADD CONSTRAINT `Fk_idRolUser` FOREIGN KEY (`IdRol`) REFERENCES `roles` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE;
